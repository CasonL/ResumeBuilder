            ...
            return (
              <section className="recommendation-section" style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '8px' }}>
                  <span style={{ fontSize: '28px', fontWeight: 800, color: scoreColor }}>{score}/10</span>
                ...
                <p style={{ fontSize: '12px', marginBottom: '10px', padding: '6px 10px', borderRadius: '6px', background: `${borderColor}14`, color: scoreColor, lineHeight: 1.5 }}>
                  {score >= 7 ? '✦ Apply directly — your resume speaks for itself here.' : score >= 5 ? '✦ Worth applying — but do it smart. Find the hiring manager on LinkedIn and send a 2-line note before submitting. A brief touchpoint turns a borderline resume into a real conversation.' : '✦ High-leverage move: close 1-2 of the gaps below first, or reach out on LinkedIn to learn what they actually prioritize before spending the effort.'}
                </p>
                <button
                ...
                {showDetails && (
                  <div style={{ marginTop: '10px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
                    <p style={{ fontSize: '13px', margin: 0, lineHeight: 1.6, color: 'var(--fg, #1a1a1a)' }}>{data.fitAssessment.honestTake}</p>
                    <p style={{ fontSize: '12px', margin: 0, color: threadColor }}>
